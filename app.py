...
def home():
    ...
    if request.method == 'POST':
        ...
        titl = "From people's reaction to " + searchTerm + ", there were " + str(noOfSearchTerms) + " comments on nairaland"

        if (negative> 60):
            comm = "There is a high percentage of negative comments regarding this job.\n It is only 29.79% likely. "
        elif(negative>30):
            comm = "There is a slight chance that this is a real job. It is 30.43% likely." 
        elif (negative<30):
            comm = "This job has high possibilities of being true. It is 67.54% likely."
